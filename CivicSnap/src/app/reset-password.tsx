...
const createStyles = (colors: any) => StyleSheet.create({
    ...
    header: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", paddingHorizontal: Variables.sizes.md, paddingVertical: Variables.sizes.md, backgroundColor: colors.surface, borderBottomWidth: 1, borderBottomColor: "#E5E5E5" },
    headerTitle: { fontFamily: Variables.fonts.bold, fontSize: Variables.textSizes.md, color: colors.text },
    saveText: { fontFamily: Variables.fonts.bold, fontSize: Variables.textSizes.base, color: colors.primary },
    ...
    instructionText: { fontFamily: Variables.fonts.regular, fontSize: Variables.textSizes.sm, color: colors.textLight, textAlign: "center", paddingHorizontal: Variables.sizes.md, lineHeight: 20 },
    inputContainer: { width: "100%", marginBottom: Variables.sizes.lg },
    label: { fontFamily: Variables.fonts.semibold, fontSize: Variables.textSizes.sm, color: colors.textLight, marginBottom: Variables.sizes.xs, marginLeft: 4 },
    passwordWrapper: { flexDirection: "row", alignItems: "center", backgroundColor: colors.surface, borderRadius: 12, borderWidth: 1, borderColor: "#E5E5E5", height: 56 },
    inputWithIcon: { flex: 1, height: "100%", paddingHorizontal: Variables.sizes.md, fontFamily: Variables.fonts.regular, fontSize: Variables.textSizes.base, color: colors.text },
